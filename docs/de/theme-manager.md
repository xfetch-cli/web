...
Im Gegensatz zu anderen info-Plugins, die Systemdaten anzeigen, interagiert theme-manager mit der Theme-Registry unter `github.com/xfetch-cli/themes`, um Theme-Dateien zu finden und herunterzuladen.
