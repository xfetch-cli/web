...
2. **Type** — What kind of security issue is it? (e.g., buffer overflow, injection, privilege escalation)
...
5. **Third-party plugins** — Only use plugins from trusted sources
